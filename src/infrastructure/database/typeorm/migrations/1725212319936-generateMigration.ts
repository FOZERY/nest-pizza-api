...
export class GenerateMigration1725212319936 implements MigrationInterface {
    name = 'GenerateMigration1725212319936'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "restaurants-products" ("productId" integer NOT NULL, "restaurantId" integer NOT NULL, "availability" boolean NOT NULL, "custom_price" integer NOT NULL, CONSTRAINT "PK_f80383efc7caeba286fd4eb4813" PRIMARY KEY ("productId", "restaurantId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "inventory" ("restaurantId" integer NOT NULL, "ingredientId" integer NOT NULL, "quantity" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a5f2abb23049ead6d3b3a07d63a" PRIMARY KEY ("restaurantId", "ingredientId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product-ingredients" ("ingredientId" integer NOT NULL, "productId" integer NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_4bf5aa08d911b255ed2d476617e" PRIMARY KEY ("ingredientId", "productId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "order_time" TIMESTAMP NOT NULL, "order_price" integer NOT NULL, "delivery_requested_time" TIMESTAMP, "delivery_actual_time" TIMESTAMP, "delivery_price" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "orderStatusId" integer, "orderTypeId" integer, "restaurantId" integer, "deliveryAddressId" integer, "userId" integer, "cashierId" integer, "courierId" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "staff" ("id" SERIAL NOT NULL, "login" character varying NOT NULL, "password" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "patronymic" character varying, "info" character varying, "phone_number" character varying(11) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "roleId" integer, "restaurantId" integer, "positionId" integer, CONSTRAINT "PK_e4ee98bb552756c180aec1e854a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users_addresses" ("usersId" integer NOT NULL, "addressesId" integer NOT NULL, CONSTRAINT "PK_18d97880f4c928d0d6aa2a9170f" PRIMARY KEY ("usersId", "addressesId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b976fa95ffa5e2419c7fd4f531" ON "users_addresses" ("usersId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b71b7361c7fc56b5dd477cd6e5" ON "users_addresses" ("addressesId") `);
        await queryRunner.query(`CREATE TABLE "staff_roles_permissions" ("staffRolesId" integer NOT NULL, "permissionsId" integer NOT NULL, CONSTRAINT "PK_36305dbbfdae753dc5fefa0338d" PRIMARY KEY ("staffRolesId", "permissionsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b34e106e502a28baa370b9ef21" ON "staff_roles_permissions" ("staffRolesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_bc40e0ed29671139cc8d4786b1" ON "staff_roles_permissions" ("permissionsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "product-ingredients" ADD CONSTRAINT "FK_d2e1b44e3578433f2186f823f9f" FOREIGN KEY ("ingredientId") REFERENCES "ingredients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product-ingredients" ADD CONSTRAINT "FK_6279a4d13a14e63e46c8009e58b" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "staff" ADD CONSTRAINT "FK_10288fdeaacf288bbd4d6469fef" FOREIGN KEY ("roleId") REFERENCES "staff-roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users_addresses" ADD CONSTRAINT "FK_b976fa95ffa5e2419c7fd4f5312" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_addresses" ADD CONSTRAINT "FK_b71b7361c7fc56b5dd477cd6e52" FOREIGN KEY ("addressesId") REFERENCES "addresses"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "staff_roles_permissions" ADD CONSTRAINT "FK_b34e106e502a28baa370b9ef21f" FOREIGN KEY ("staffRolesId") REFERENCES "staff-roles"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "staff_roles_permissions" ADD CONSTRAINT "FK_bc40e0ed29671139cc8d4786b13" FOREIGN KEY ("permissionsId") REFERENCES "permissions"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "staff_roles_permissions" DROP CONSTRAINT "FK_bc40e0ed29671139cc8d4786b13"`);
        await queryRunner.query(`ALTER TABLE "staff_roles_permissions" DROP CONSTRAINT "FK_b34e106e502a28baa370b9ef21f"`);
        await queryRunner.query(`ALTER TABLE "users_addresses" DROP CONSTRAINT "FK_b71b7361c7fc56b5dd477cd6e52"`);
        await queryRunner.query(`ALTER TABLE "users_addresses" DROP CONSTRAINT "FK_b976fa95ffa5e2419c7fd4f5312"`);
        ...
        await queryRunner.query(`ALTER TABLE "product-ingredients" DROP CONSTRAINT "FK_6279a4d13a14e63e46c8009e58b"`);
        await queryRunner.query(`ALTER TABLE "product-ingredients" DROP CONSTRAINT "FK_d2e1b44e3578433f2186f823f9f"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bc40e0ed29671139cc8d4786b1"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b34e106e502a28baa370b9ef21"`);
        await queryRunner.query(`DROP TABLE "staff_roles_permissions"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b71b7361c7fc56b5dd477cd6e5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b976fa95ffa5e2419c7fd4f531"`);
