...
export class Migrations1724447478470 implements MigrationInterface {
    name = 'Migrations1724447478470'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "inventory" ("restaurantId" integer NOT NULL, "ingredientId" integer NOT NULL, "quantity" numeric(10,2) NOT NULL, CONSTRAINT "PK_a5f2abb23049ead6d3b3a07d63a" PRIMARY KEY ("restaurantId", "ingredientId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "staff-roles_permissions_permissions" ("staffRolesId" integer NOT NULL, "permissionsId" integer NOT NULL, CONSTRAINT "PK_5a4bb26759f28a3d170ce18eb8f" PRIMARY KEY ("staffRolesId", "permissionsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_72ad394ad0ee34935e77b28689" ON "staff-roles_permissions_permissions" ("staffRolesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_558fda49fabe146f2fc6a592b9" ON "staff-roles_permissions_permissions" ("permissionsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "staff-roles_permissions_permissions" ADD CONSTRAINT "FK_72ad394ad0ee34935e77b28689a" FOREIGN KEY ("staffRolesId") REFERENCES "staff-roles"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "staff-roles_permissions_permissions" ADD CONSTRAINT "FK_558fda49fabe146f2fc6a592b95" FOREIGN KEY ("permissionsId") REFERENCES "permissions"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "staff-roles_permissions_permissions" DROP CONSTRAINT "FK_558fda49fabe146f2fc6a592b95"`);
        await queryRunner.query(`ALTER TABLE "staff-roles_permissions_permissions" DROP CONSTRAINT "FK_72ad394ad0ee34935e77b28689a"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_558fda49fabe146f2fc6a592b9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_72ad394ad0ee34935e77b28689"`);
        await queryRunner.query(`DROP TABLE "staff-roles_permissions_permissions"`);
